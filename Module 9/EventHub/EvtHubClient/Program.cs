...
class Program
{
    private static string conStr = "Endpoint=sb://ps-myns.servicebus.windows.net/;SharedAccessKeyName=schrijver;SharedAccessKey=32Hc5hGcJb2+tafkS5nUguhqiVA/2phkE+AEhBS5ucA=;EntityPath=hup";
